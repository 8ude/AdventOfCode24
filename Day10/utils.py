...
piecemeal copied from aoc_lube repo, mostly by salt-die -- https://github.com/salt-die/aoc_lube/blob/main/aoc_lube/utils.py

works with python 3.11 or higher (I think...? Some might require more latest version)
